...
-- col[0]	=>  Location: PIN_127,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 16mA
-- col[1]	=>  Location: PIN_129,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 16mA
-- col[2]	=>  Location: PIN_131,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 16mA
-- col[3]	=>  Location: PIN_133,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 16mA
...
-- rst	=>  Location: PIN_142,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- row[0]	=>  Location: PIN_119,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- row[1]	=>  Location: PIN_121,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- row[2]	=>  Location: PIN_123,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- row[3]	=>  Location: PIN_125,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- clk	=>  Location: PIN_89,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF lcd_mf IS
...
\count[5]\ : maxv_lcell
-- Equation(s):
-- \Equal0~1\ = (!count(3) & (!count(4) & (count[5] & !count(2))))
...
\count[6]\ : maxv_lcell
-- Equation(s):
-- \Equal0~3\ = (!count(7) & (!count(9) & (!count[6] & count(8))))
...
\Add0~65\ : maxv_lcell
-- Equation(s):
-- \Add0~65_combout\ = (!\Add0~37\ & \Add0~62\) # (\Add0~37\ & \Add0~62COUT1_122\) $ (((count(7) & (\rst~combout\))))
-- \Add0~67\ = CARRY(((!\Add0~62\) # (!\rst~combout\)) # (!count(7)))
-- \Add0~67COUT1_124\ = CARRY(((!\Add0~62COUT1_122\) # (!\rst~combout\)) # (!count(7)))
...
\count~6\ : maxv_lcell
-- Equation(s):
-- \count~6_combout\ = (((count(8) & \rst~combout\)))
...
\Add0~80\ : maxv_lcell
-- Equation(s):
-- \Add0~80_combout\ = (!\Add0~57\ & \Add0~72\) # (\Add0~57\ & \Add0~72COUT1_126\) $ ((((!count(10))) # (!\rst~combout\)))
-- \Add0~82\ = CARRY((\rst~combout\ & (count(10) & !\Add0~72\)))
-- \Add0~82COUT1_128\ = CARRY((\rst~combout\ & (count(10) & !\Add0~72COUT1_126\)))
...
\count[10]\ : maxv_lcell
-- Equation(s):
-- \Equal0~4\ = (!count(12) & (!count(11) & (!count[10] & count(13))))
...
\count[12]\ : maxv_lcell
-- Equation(s):
-- count(12) = DFFEAS((((\Add0~90_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
\count~4\ : maxv_lcell
-- Equation(s):
-- \count~4_combout\ = ((\rst~combout\ & ((count(17)))))
...
\Add0~30\ : maxv_lcell
-- Equation(s):
-- \Add0~30_combout\ = \Add0~52\ $ ((((!\rst~combout\)) # (!count(2))))
-- \Add0~32\ = CARRY((count(2) & (\rst~combout\ & !\Add0~52\)))
-- \Add0~32COUT1_116\ = CARRY((count(2) & (\rst~combout\ & !\Add0~52COUT1_114\)))
...
\Add0~35\ : maxv_lcell
-- Equation(s):
-- \Add0~35_combout\ = \Add0~32\ $ (((\rst~combout\ & (count(3)))))
-- \Add0~37\ = CARRY(((!\Add0~32COUT1_116\) # (!count(3))) # (!\rst~combout\))
...
\Equal0~5\ : maxv_lcell
-- Equation(s):
-- \Equal0~5_combout\ = (\Equal0~3\ & (\Equal0~4\ & (\Equal0~0\ & \Equal0~2\)))
...
\Equal2~0\ : maxv_lcell
-- Equation(s):
-- \Equal2~0_combout\ = (\row~combout\(1)) # ((\row~combout\(2)) # ((\row~combout\(3)) # (\row~combout\(0))))
...
-- Equation(s):
-- temp_row(2) = DFFEAS((((\row~combout\(2)))), GLOBAL(\temp_clk~regout\), VCC, , \temp_row[3]~1_combout\, , , , )
...
-- Equation(s):
-- \temp[0]~1\ = (\row~combout\(3) & (temp_row[3] & (\row~combout\(2) $ (!temp_row(2))))) # (!\row~combout\(3) & (!temp_row[3] & (\row~combout\(2) $ (!temp_row(2)))))
...
-- Equation(s):
-- \temp[0]~0\ = (\row~combout\(1) & (temp_row[1] & (temp_row(0) $ (!\row~combout\(0))))) # (!\row~combout\(1) & (!temp_row[1] & (temp_row(0) $ (!\row~combout\(0)))))
...
-- Equation(s):
-- \WideOr15~1_combout\ = (\WideOr15~0_combout\ & (\WideNor6~combout\ & (\WideNor8~combout\ & \WideNor7~combout\)))
...
-- Equation(s):
-- \state.000~regout\ = DFFEAS(((!\WideNor5~combout\ & (!\WideOr15~1_combout\))), GLOBAL(\temp_clk~regout\), GLOBAL(\rst~combout\), , , , , , )
...
-- Equation(s):
-- \Selector17~0_combout\ = (count_cmd(2) & (!\WideNor3~combout\ & ((count_cmd(1)) # (count_cmd(0)))))
...
WideNor5 : maxv_lcell
-- Equation(s):
-- \WideNor5~combout\ = (!\state.100~regout\ & (!\state.101~regout\ & (\WideNor5~0\ & \state.010~regout\)))
...
-- Equation(s):
-- \col[3]~reg0_regout\ = DFFEAS((\col[2]~reg0_regout\) # ((\col[1]~reg0_regout\) # ((!\col[0]~reg0_regout\) # (!\col[3]~reg0_regout\))), GLOBAL(\temp_clk~regout\), GLOBAL(\rst~combout\), , \col[0]~0_combout\, , , , )
...
PORT MAP (
	...
	datab => \col[1]~reg0_regout\,
	datac => \col[3]~reg0_regout\,
	datad => \col[0]~reg0_regout\,
	aclr => \ALT_INV_rst~combout\,
	ena => \col[0]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \col[0]~reg0_regout\ = DFFEAS((((\col[1]~reg0_regout\))), GLOBAL(\temp_clk~regout\), GLOBAL(\rst~combout\), , \col[0]~0_combout\, , , , )
...
\temp[0]~2\ : maxv_lcell
-- Equation(s):
-- \temp[0]~2_combout\ = (\state_debounce.01~regout\ & (\temp[0]~0\ & (\temp[0]~1\ & \rst~combout\)))
...
\temp[5]\ : maxv_lcell
-- Equation(s):
-- \WideOr4~2\ = (temp(0) & (temp(4) & (!temp[5] & !temp(3)))) # (!temp(0) & (!temp(4) & (temp[5] & temp(3))))
...
\temp[6]\ : maxv_lcell
-- Equation(s):
-- \WideOr1~0\ = (!temp(5) & (((temp[6] & !temp(4)))))
...
\temp[2]\ : maxv_lcell
-- Equation(s):
-- \WideOr6~0\ = (temp(1) & (!temp(6) & (!temp[2] & temp(4)))) # (!temp(1) & (temp(6) & (temp[2] & !temp(4))))
...
\temp[7]\ : maxv_lcell
-- Equation(s):
-- \WideOr2~1\ = (!temp[7] & ((temp(1) & (!temp(2) & !temp(3))) # (!temp(1) & (temp(2) $ (temp(3))))))
...
\temp[1]\ : maxv_lcell
-- Equation(s):
-- \WideOr9~3\ = (temp(5) & (!temp(7) & (temp(2) $ (temp[1])))) # (!temp(5) & (temp(7) & (temp(2) $ (temp[1]))))
...
-- Equation(s):
-- \WideOr6~1_combout\ = (\WideOr11~2\ & (!temp(3) & (\WideOr6~0\ & !temp(7))))
...
-- Equation(s):
-- \WideOr6~3_combout\ = (temp(0) & (((!temp(1) & !temp(3))))) # (!temp(0) & ((temp(1) $ (temp(3)))))
...
-- Equation(s):
-- \WideOr6~4_combout\ = (!temp(2) & (\WideOr6~3_combout\ & (temp(7) $ (temp(5)))))
...
-- Equation(s):
-- \WideOr0~1_combout\ = ((temp(0) & (!temp(1) & !temp(2))))
...
-- Equation(s):
-- \WideOr5~0_combout\ = (!temp(0) & (!temp(5) & (temp(1) $ (temp(2)))))
...
-- Equation(s):
-- \WideOr5~1_combout\ = (temp(7) & (((\WideOr5~0_combout\)))) # (!temp(7) & (\WideOr0~1_combout\ & (temp(5))))
...
-- Equation(s):
-- \WideOr5~3_combout\ = (temp(4) & (!temp(5) & (temp(1) $ (temp(3))))) # (!temp(4) & (temp(5) & (!temp(1) & temp(3))))
...
-- Equation(s):
-- \WideOr8~3_combout\ = ((!temp(7) & (!temp(0) & !temp(6))))
...
-- Equation(s):
-- \WideOr5~4_combout\ = (\WideOr5~2_combout\ & ((\WideOr1~0\) # ((\WideOr5~3_combout\ & \WideOr8~3_combout\)))) # (!\WideOr5~2_combout\ & (\WideOr5~3_combout\ & ((\WideOr8~3_combout\))))
...
-- Equation(s):
-- \lcd[1]~reg0_regout\ = DFFEAS((\WideOr12~0_combout\ & (((\Mux4~0_combout\ & !count_cmd(0))))) # (!\WideOr12~0_combout\ & (lcd_dat(1))), GLOBAL(\temp_clk~regout\), VCC, , \lcd[0]~0_combout\, , , , )
...
-- Equation(s):
-- \WideOr4~5_combout\ = (\WideOr4~2\ & (!temp(1) & (!temp(6) & !temp(2))))
...
-- Equation(s):
-- \lcd[2]~reg0_regout\ = DFFEAS((\WideOr12~0_combout\ & (((!count_cmd(0) & \Mux4~0_combout\)))) # (!\WideOr12~0_combout\ & (lcd_dat(2))), GLOBAL(\temp_clk~regout\), VCC, , \lcd[0]~0_combout\, , , , )
...
-- Equation(s):
-- \WideOr0~0_combout\ = ((!temp(1) & ((!temp(2)))))
...
-- Equation(s):
-- \WideOr3~0_combout\ = (temp(3) & (temp(4) & (!temp(5) & \WideOr0~0_combout\)))
...
-- Equation(s):
-- \WideOr3~1_combout\ = (temp(5) & (!temp(3) & (temp(1) $ (temp(2)))))
...
-- Equation(s):
-- lcd_dat(3) = DFFEAS((\WideOr8~3_combout\ & ((\WideOr3~0_combout\) # ((\WideOr3~1_combout\ & !temp(4))))), GLOBAL(\temp_clk~regout\), VCC, , , , , !\rst~combout\, )
...
-- Equation(s):
-- \lcd[3]~reg0_regout\ = DFFEAS((\WideOr12~0_combout\ & (!count_cmd(2) & ((!count_cmd(0))))) # (!\WideOr12~0_combout\ & (((lcd_dat(3))))), GLOBAL(\temp_clk~regout\), VCC, , \lcd[0]~0_combout\, , , , )
...
-- Equation(s):
-- \WideOr9~0_combout\ = ((!temp(7) & (!temp(1) & !temp(3))))
...
-- Equation(s):
-- \WideOr2~3_combout\ = (temp(7) & ((temp(1) & (!temp(3) & !temp(2))) # (!temp(1) & (temp(3) $ (temp(2))))))
...
-- Equation(s):
-- \WideOr2~4_combout\ = (temp(4) & (\WideOr9~0_combout\ & ((temp(2))))) # (!temp(4) & (((\WideOr2~3_combout\))))
...
-- Equation(s):
-- \WideOr1~2_combout\ = ((!temp(4) & (!temp(5) & !temp(6))))
...
-- Equation(s):
-- \WideOr1~1_combout\ = (\WideOr2~1\ & ((temp(4) & (!temp(5) & !temp(6))) # (!temp(4) & (temp(5) $ (temp(6))))))
...
-- Equation(s):
-- \lcd[5]~reg0_regout\ = DFFEAS((\WideOr12~0_combout\ & (\Selector14~0_combout\ & ((!count_cmd(0))))) # (!\WideOr12~0_combout\ & (((lcd_dat(5))))), GLOBAL(\temp_clk~regout\), VCC, , \lcd[0]~0_combout\, , , , )
...
-- Equation(s):
-- \WideOr0~2_combout\ = (temp(5) & (!temp(6) & (!temp(4) & !temp(7)))) # (!temp(5) & ((temp(6) & (!temp(4) & !temp(7))) # (!temp(6) & (temp(4) $ (temp(7))))))
...
-- Equation(s):
-- lcd_dat(6) = DFFEAS((!temp(3) & (((\WideOr0~2_combout\ & \WideOr0~1_combout\)))), GLOBAL(\temp_clk~regout\), VCC, , , , , !\rst~combout\, )
...
-- Equation(s):
-- \Selector8~0_combout\ = (((\WideNor4~combout\ & !\WideNor5~combout\)))
...
-- Equation(s):
-- \lcd[6]~reg0_regout\ = DFFEAS((lcd_dat(6) & (\WideNor3~combout\ & (\Selector8~0_combout\ & !\WideOr12~0_combout\))), GLOBAL(\temp_clk~regout\), VCC, , \lcd[0]~0_combout\, , , , )
...
-- Equation(s):
-- \WideOr11~3_combout\ = (temp(6) & (!temp(2) & (temp(3) $ (temp(1))))) # (!temp(6) & (!temp(1) & (temp(3) $ (temp(2)))))
...
-- Equation(s):
-- \WideOr11~5_combout\ = ((\WideOr11~4_combout\ & (temp(0) $ (temp(2)))))
...
-- Equation(s):
-- \WideOr11~6_combout\ = (!temp(1) & (\WideOr11~5_combout\ & (temp(5) $ (temp(7)))))
...
-- Equation(s):
-- \WideOr10~3_combout\ = (temp(6) & (!temp(5) & (!temp(4) & temp(2)))) # (!temp(6) & (temp(5) $ ((temp(4)))))
...
-- Equation(s):
-- \WideOr10~4_combout\ = (\WideOr9~0_combout\ & (\WideOr10~3_combout\ & (temp(2) $ (temp(0)))))
...
-- Equation(s):
-- \WideOr10~1_combout\ = (temp(1) & (!temp(6) & (temp(5) & !temp(3)))) # (!temp(1) & (((!temp(5) & temp(3)))))
...
-- Equation(s):
-- \WideOr10~2_combout\ = (\WideOr10~1_combout\ & ((temp(7) & (temp(3) & !temp(6))) # (!temp(7) & (temp(3) $ (!temp(6))))))
...
-- Equation(s):
-- \WideOr9~6_combout\ = (temp(2) & (temp(4) & (!temp(0) & !temp(6)))) # (!temp(2) & (!temp(4) & (temp(0) & temp(6))))
...
-- Equation(s):
-- \WideOr9~1_combout\ = temp(0) $ ((((temp(3)))))
...
-- Equation(s):
-- \WideOr9~2_combout\ = (temp(7) & (\WideOr0~0_combout\ & (!temp(5) & \WideOr9~1_combout\)))
...
-- Equation(s):
-- \WideOr9~5_combout\ = (!temp(6) & (!temp(4) & ((\WideOr9~2_combout\) # (\WideOr9~4_combout\))))
...
-- Equation(s):
-- \led[2]~reg0_regout\ = DFFEAS((!\WideOr9~5_combout\ & ((temp(5)) # ((!\WideOr9~0_combout\) # (!\WideOr9~6_combout\)))), GLOBAL(\temp_clk~regout\), VCC, , \rst~combout\, , , , )
...
-- Equation(s):
-- \WideOr8~1_combout\ = (!temp(6) & (!temp(1) & (!temp(0) & !temp(7))))
...
-- Equation(s):
-- \WideOr8~4_combout\ = ((temp(1) & (!temp(3) & !temp(2))) # (!temp(1) & (temp(3) $ (temp(2)))))
...
-- Equation(s):
-- \WideOr8~0_combout\ = (temp(4) & (!temp(5) & (!temp(3) & temp(2)))) # (!temp(4) & (temp(5) & (temp(3) & !temp(2))))
...
-- Equation(s):
-- \led[3]~reg0_regout\ = DFFEAS((\WideOr8~1_combout\ & (!\WideOr8~0_combout\ & ((!\WideOr8~5_combout\) # (!\WideOr11~2\)))) # (!\WideOr8~1_combout\ & (((!\WideOr8~5_combout\)) # (!\WideOr11~2\))), GLOBAL(\temp_clk~regout\), VCC, , \rst~combout\, , , , )
...
-- Equation(s):
-- \WideOr7~0_combout\ = (temp(5) & (!temp(6) & (!temp(4) & !temp(7)))) # (!temp(5) & ((temp(6) & (!temp(4) & !temp(7))) # (!temp(6) & (temp(4) $ (temp(7))))))
...
-- Equation(s):
-- \led[4]~reg0_regout\ = DFFEAS((((!\WideOr7~1_combout\) # (!\WideOr7~0_combout\))), GLOBAL(\temp_clk~regout\), VCC, , \rst~combout\, , , , )
