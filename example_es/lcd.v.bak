...
begin
 ...
 msg[0]<="   Available    ";	//at the beginning on reset index will be displayed. Thus msg[0],msg[1],msg[2],msg[3] are displayed
 msg[1]<="1.pepsi=Rs.15  ";	// in place of @@@, price is printed
 msg[2]<="2.lays =Rs.10  ";
 msg[3]<="3.toy  =Rs.20  ";
 msg[4]<="Total Cost=@@@  ";	//After input item and qty is selected this msg is displayed
